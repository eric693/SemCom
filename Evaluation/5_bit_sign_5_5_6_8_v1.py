...
embeds_shared = Embeds(vocab_size=141, num_hidden=512).to(device)
encoder = LSTMEncoder(channel_dim=channel_dim, embedds=embeds_shared).to(device)
decoder = LSTMDecoder(channel_dim=channel_dim, embedds=embeds_shared, vocab_size = 141).to(device)
...
input_str = "['amy draws pictures with chalk']"
