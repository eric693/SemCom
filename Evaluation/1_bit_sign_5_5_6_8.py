    ...
    with open('log.txt', 'w') as log_file:
        for input_str in SemanticRL_example:
            ...
            for ckpt_dir in [args.ckpt_pathRL]:#, args.ckpt_pathRL
                ...
                # encoder.load_state_dict(torch.load('/home/eric/research/SemanticRL/ckpt_AWGN_RL/1bit_16/encoder_epoch201.pth', map_location='cpu'))
                # decoder.load_state_dict(torch.load('/home/eric/research/SemanticRL/ckpt_AWGN_RL/1bit_16/decoder_epoch201.pth', map_location='cpu'))
                # embeds_shared.load_state_dict(torch.load('/home/eric/research/SemanticRL/ckpt_AWGN_RL/1bit_16/embeds_shared_epoch201.pth',  map_location='cpu'))
