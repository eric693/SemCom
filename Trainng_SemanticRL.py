...
parser.add_argument("--reward_type", type=str, default='BLER')  # BLEU, CIDEr
...
embeds_shared = get_model('Embeds')(vocab_size = data_train.get_dict_len(), num_hidden=512).to(device)
